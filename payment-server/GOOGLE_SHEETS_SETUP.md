...
### Шаг 6.2: Добавление новых столбцов для оплаты

Добавьте **4 новых столбца** после существующих:

#### Столбец X: payment_status
...
#### Столбец Y: payment_order_id
- **Заголовок:** `payment_order_id`
- **Описание:** ID заказа в платежной системе
- **Формат:** `APML_GROUPA_1699999999_ABC123`

#### Столбец Z: payment_timestamp
- **Заголовок:** `payment_timestamp`
- **Описание:** Дата и время оплаты
- **Формат:** ISO 8601, например: `2025-11-10T15:30:00.000Z`

#### Столбец AA: registration_timestamp
- **Заголовок:** `registration_timestamp`
- **Описание:** Timestamp регистрации (для связи с платежом)
- **Формат:** Unix timestamp в миллисекундах, например: `1699999999999`
...
```
| A | B | C | ... | W | X | Y | Z | AA |
| Group | Team | Captain | ... | Player5_ID | payment_status | payment_order_id | payment_timestamp | registration_timestamp |
```
...
- ✅ В таблице добавлены столбцы X, Y, Z, AA
